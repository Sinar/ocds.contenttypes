...
#
#  $ bin/test -s politikus.ocds -t test_infrastructure_project.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src politikus.ocds.testing.POLITIKUS_OCDS_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot /src/politikus/ocds/tests/robot/test_infrastructure_project.robot
#
