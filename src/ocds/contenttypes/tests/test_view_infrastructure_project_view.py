...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_infrastructure_project_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='infrastructure-project-view'
        )
        self.assertTrue(view.__name__ == 'infrastructure-project-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in infrastructure-project-view'
        # )

    def test_infrastructure_project_view_not_matching_interface(self):
