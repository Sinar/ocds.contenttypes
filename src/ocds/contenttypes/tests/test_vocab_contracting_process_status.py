...
class ContractingProcessStatusIntegrationTest(unittest.TestCase):
    ...
    def test_vocab_contracting_process_status(self):
        vocab_name = 'ocds.contenttypes.ContractingProcessStatus'
